        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            <CardBody className="text-center p-6">
              ...
              <p className="text-2xl font-bold text-gray-900">{parseFloat(stats.revenue.total_revenue).toFixed(2)} ETB</p>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody className="text-center p-6">
              ...
              <p className="text-2xl font-bold text-gray-900">{parseFloat(stats.revenue.today_revenue).toFixed(2)} ETB</p>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody className="text-center p-6">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.revenue.total_transactions}</p>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody className="text-center p-6">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.revenue.today_transactions}</p>
            </CardBody>
          </Card>
        </div>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardBody>
              {stats.recentEvents && stats.recentEvents.length > 0 ? (
                  ...
                  {stats.recentEvents.map((event) => (
                    <div key={event.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-gray-900">{event.tickets_sold} / {event.capacity}</p>
                ...
                <p className="text-gray-600 text-center py-4">No recent events</p>
              )}
            </CardBody>
          </Card>
        </div>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {stats.recentBookings.map((booking) => (
                      <tr key={booking.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-900">{parseFloat(booking.total_amount).toFixed(2)} ETB</td>
