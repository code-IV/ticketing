...
const isAuthenticated = (req, res, next) => {
  ...
  return apiResponse(res, 401, false, 'Authentication required. Please log in.');
};
...
const isAdmin = (req, res, next) => {
  ...
  return apiResponse(res, 403, false, 'Access denied. Admin privileges required.');
};
...
const isOwnerOrAdmin = (paramName = 'userId') => {
  return (req, res, next) => {
    ...
    return apiResponse(res, 403, false, 'Access denied. You can only access your own resources.');
  };
};
