                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {reportData.revenue.thisMonth}
                      </p>
                      <p
                        className={`text-sm ${reportData.revenue.growth.monthly >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                        {reportData.revenue.growth.monthly >= 0 ? "+" : ""}
                        {reportData.revenue.growth.monthly}% this month
                      </p>
                    </div>
                  </div>
                </div>
