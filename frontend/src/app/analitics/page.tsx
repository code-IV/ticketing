        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
              ...
              <p className="text-sm text-gray-600 mt-1">Revenue trends and performance by game</p>
            </div>
            <div className="p-6 space-y-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-4">Top Games by Revenue</h3>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
              <h2 className="text-lg font-semibold text-gray-900">Ticket Sales Analytics</h2>
              <p className="text-sm text-gray-600 mt-1">Total tickets sold over time</p>
            </div>
            <div className="p-6">
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <h3 className="font-semibold text-gray-900 mb-4">Total Tickets Sold</h3>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
              ...
              <p className="text-sm text-gray-600 mt-1">Latest event activities and performance</p>
            </div>
            <div className="p-6">
