...
const PhoneIcon = () => (
  <svg
    ...
    strokeWidth="2"
  >
    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8a19.79 19.79 0 01-3.07-8.68A2 2 0 012 .93h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
  </svg>
);
...
const VisualPanel = ({
  ...
  return (
    ...
    >
      ...
      {/* Overlays */}
      <div
        style={{ position: "absolute", inset: 0, background: t.overlayGrad }}
      />
      <div
        style={{
          position: "absolute",
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: "0 8px 32px rgba(255,216,77,0.3)",
          zIndex: 10,
        }}
      >
      ...
      >
        <motion.div
          ...
          style={{
            ...
            border: "2px dashed rgba(255,216,77,0.4)",
            borderRadius: "50%",
          }}
        />
        <div
      ...
      {!compact && (
        ...
        >
          ...
          >
            Book rides, track your tickets, and plan your visit — all in one
            place.
          </p>
          {/* Image dots */}
            ...
            {BG_IMAGES.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 999,
                  background: i === imgIndex ? ACCENT : t.dotInactive,
                  border: "none",
                  padding: 0,
                  cursor: "pointer",
                  transition: "all 0.3s",
      ...
      >
        ...
        >
          ...
          <span
            style={{
              fontSize: 12,
              color: isDark ? "rgba(255,255,255,0.4)" : "rgba(17,17,17,0.5)",
      ...
      <AnimatePresence>
        {globalError && (
          ...
          >
            ...
            />
            <span style={{ fontSize: 13, color: t.errorText }}>
              {globalError}
            </span>
          </motion.div>
        )}
        {success && (
          ...
          >
            ...
            />
            <span style={{ fontSize: 13, color: t.successText }}>
              {success}
            </span>
          </motion.div>
        )}
