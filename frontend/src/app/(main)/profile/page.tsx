...
const StatCard = ({ number, label }: { number: string; label: string }) => {
  ...
  return (
    <div
      className={`px-4 py-3 rounded-xl text-center backdrop-blur-sm ${
  ...
  if (!user) {
    return (
      ...
      >
        ...
        >
          <p
            className={`mb-6 ${isDarkTheme ? "text-white/40" : "text-black/50"}`}
          >
                  ...
                  <div className="flex flex-col space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span
                          className="inline-block mt-2 px-3 py-1 rounded-full text-xs font-bold tracking-wider uppercase w-fit"
                          style={{
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span
                            className={`inline-flex px-3 py-1 text-xs font-bold rounded-full w-fit ${
                              user.is_active
                                ? isDarkTheme
