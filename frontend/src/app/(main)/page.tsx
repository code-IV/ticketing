                    ...
                    >
                      ...
                      >
                        ...
                        <div className="w-[40%] space-y-10">
                          <h3
                            className={`text-7xl xl:text-8xl font-black tracking-tighter leading-[0.85] uppercase ${isDarkTheme ? "text-white" : "text-zinc-900"}`}
                          >
                            {event.name}
                          </h3>

                          <p
                            className={`text-xl font-medium leading-relaxed opacity-60 ${isDarkTheme ? "text-zinc-400" : "text-zinc-600"}`}
                          >
                            {event.description ||
